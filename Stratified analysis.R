...
# patient_data[, 'POS_G'] = factor(patient_data[, 'CXR[POSITION]'])
# patient_data[, 'DM'] = factor(patient_data[, 'DM'])
# levels(patient_data[, 'DM']) = c('Without DM', 'With DM')
# patient_data[, 'HTN'] = factor(patient_data[, 'HTN'])
# levels(patient_data[, 'HTN']) = c('Without HTN', 'With HTN')
# patient_data[, 'HLP'] = factor(patient_data[, 'HLP'])
# levels(patient_data[, 'HLP']) = c('Without HLP', 'With HLP')
# patient_data[, 'CKD'] = factor(patient_data[, 'CKD'])
# levels(patient_data[, 'CKD']) = c('Without CKD', 'With CKD')
# patient_data[, 'CAD'] = factor(patient_data[, 'CAD'])
# levels(patient_data[,'CAD']) = c('Without CAD', 'With CAD')
# patient_data[, 'HF'] = factor(patient_data[, 'HF'])
# levels(patient_data[, 'HF']) = c('Without HF', 'With HF')
# patient_data[,'COPD'] = factor(patient_data[, 'COPD'])
# levels(patient_data[, 'COPD']) = c('Without COPD', 'With COPD')
